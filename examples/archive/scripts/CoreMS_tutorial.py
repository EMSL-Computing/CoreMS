...
file_location =  "tests/tests_data/ftms/srfa_bruker_solarix_direct_infusion/ESI_NEG_SRFA.d"
...
ref_file_location = 'tests/tests_data/ftms/srfa_bruker_solarix_direct_infusion/SRFA.ref'
