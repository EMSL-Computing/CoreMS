...
def calibrate(mass_spectrum_obj):
    ...
    MoleculaSearchSettings.min_abun_error = -80 # percentage
    MoleculaSearchSettings.max_abun_error = 80 # percentage
...
def assign_mf_pox(mass_spectrum_obj):
    ...
    lookupTableSettings.usedAtoms['O'] = (4, 18)
...
def search_mf(mass_spectrum_obj):
    ...
    lookupTableSettings.usedAtoms['O'] = (4, 18)
    lookupTableSettings.usedAtoms['N'] = (0, 5)
    lookupTableSettings.usedAtoms['S'] = (0, 5)
    lookupTableSettings.usedAtoms['Cl'] = (0, 0)
...
if __name__ == "__main__":
    ...
    import matplotlib
    matplotlib.use('Agg')
    file_location = os.path.join(os.getcwd(), "data/201909_ldiesiappi_elliot/") + os.path.normcase("20190912_Kew_LDI_Elliot_Whole_B15_1500um_0_B15_000001.d")
    ...
    MoleculaSearchSettings.error_method = 'None'
    MoleculaSearchSettings.min_mz_error = -0.7
    MoleculaSearchSettings.max_mz_error = 0.7
    MoleculaSearchSettings.mz_error_range = 1
    MoleculaSearchSettings.mz_error_average = 0
