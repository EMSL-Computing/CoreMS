...
def test_lcms_peakpick():
    ...
    file_raw = Path.cwd() / "tests/tests_data/lcms/" / "Blanch_Nat_Lip_C_12_AB_M_17_NEG_25Jan18_Brandi-WCSH5801.raw"
    ...
    myLCMSobj.parameters.lc_ms.ph_inten_min = myLCMSobj._ms_unprocessed[1].intensity.max()*0.05*0.01 
    myLCMSobj.parameters.lc_ms.ph_persis_min = myLCMSobj._ms_unprocessed[1].intensity.max()*0.05
