...
class MSPeakCalculation(object):
    ...
    def lorentz_pdf(self, datapoint=10000):
        ...
        if self.resolving_power:
            ...
            mz_domain = linspace(self.mz_exp - hw_base_distance, self.mz_exp+ hw_base_distance, datapoint)
            ...
            raise LookupError('resolving power is not defined, try to use set_max_resolving_power()')    
    ...
    def gaussian_pdf(self, datapoint=10000):
        ...
        if self.resolving_power:
            ...
            mz_domain = linspace(self.mz_exp - n_d, self.mz_exp+ n_d, datapoint)
