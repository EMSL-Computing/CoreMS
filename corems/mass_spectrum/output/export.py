    ...
    def get_list_dict_data(self, mass_spectrum, include_no_match=True, include_isotopolgues=True,
        ...
        def add_no_match_dict_data():
            ...
            dict_result = {'Index': index,
                           ...
                           'Heteroatom Class' : Labels.unassigned.decode('utf-8')
                           }
        ...
        def add_match_dict_data():
            ...
            dict_result = {'Index': index,
                           ...
                           'S/N':  ms_peak.signal_to_noise,
                           'Ion Charge': ms_peak.ion_charge,
                           'Mass Error (ppm)': m_formula._calc_assignment_mass_error(ms_peak.mz_exp),
                           'DBE':  m_formula.dbe,
                           'Heteroatom Class': m_formula.class_label.decode('utf-8'),
                           'H/C':  m_formula.H_C,
                           'O/C':  m_formula.O_C,
                           'Ion Type': m_formula.ion_type.lower().decode('utf-8'),
