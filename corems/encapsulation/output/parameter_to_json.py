...
from corems.encapsulation.output.parameter_to_dict import get_dict_data_lcms, get_dict_lcms_default_data
...
def dump_lcms_settings_json(filename='SettingsCoreMS.json', file_path=None, lcms_obj=None):
    """
...
def dump_lcms_settings_toml(filename='SettingsCoreMS.toml', file_path=None, lcms_obj=None):
    """
